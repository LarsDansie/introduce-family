...
class familyAPI {
    static func getFamily() -> [FamilyMember] {
        let familyMembers = [
            FamilyMember(name: "Jamie Moore", relation: "Mother", bio: "Here is my loving mom, she is REDACTED years old, born and raised in Utah. Her hobbies include gardening, loving up on her cute four year old granddaughter, and road trips.", image: UIImage(named: "Jamie")),
            FamilyMember(name: "Dan Moore", relation: "Step-Dad", bio: "Here is my large step-dad, he's a lot softer than he comes across. Major history buff, pretends he doesn't like cats, and also obsessed with his granddaughter.", image: UIImage(named: "Dan")),
            FamilyMember(name: "Daniel and Lindsay Dansie", relation: "Older Brother and Sister-In-Law", bio: "Here is my brother Daniel and his wife Lindsay, parents of four year old princess Mira. Hobbies include listening to German Rock Bands, Magic The Gathering, watching shows with their daughter Mira, and going on cute dates together.", image: UIImage(named: "Lindsay")),
            FamilyMember(name: "Hyrum Dansie", relation: "Older Brother", bio: "Here is my older brother Hyrum, he has been an incredible inspiration to me since my earliest memories. Incredibly talented, creative and outgoing. Hobbies include painting miniatures for board games, D&D, Cosplay, Writing and exploring nature.", image: UIImage(named: "Hyrum")),
